  ...
  return (
    <Container>
      <div className="flex h-full flex-col items-center justify-center">
        <h1 className="via-purple-500 mb-20 inline-block bg-gradient-to-l from-indigo-500 to-pink-500 bg-clip-text p-4 text-7xl font-semibold tracking-tighter text-transparent">
          Manifold Year in Review
        </h1>

        <div className="grid w-full auto-rows-[200px] grid-cols-2 gap-3 md:grid-cols-4 lg:grid-cols-6">
          <Card className="lg:col-[2] lg:row-[1]">
          ...
          <CardWithExternalLink href="https://manifold.markets/charity" className="!bg-blue lg:col-[2] lg:row-[2]">
          ...
          >
            ...
            <div className="shrink-0 text-center text-foreground-light">Most popular market</div>
          </CardWithExternalLink>
          <Card className="lg:col-[5] lg:row-[2]">
            <div className="flex flex-1 flex-col items-center justify-center gap-3 overflow-clip">
